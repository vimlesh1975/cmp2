Public Class clsResizeableControlnew
    ...
    Private Sub ResetResizeState(control As Control)
        mEdge = EdgeEnum.None
        control.Refresh()
    ...
    Private Sub mControl_MouseMove(ByVal sender As Object,
        ...
        Else
            Select Case True
                Case e.X > c.Width - mWidth And e.Y > c.Height - mWidth
                    c.Cursor = Cursors.SizeNWSE
                    mEdge = EdgeEnum.BottomRight
                Case e.X <= mWidth And e.Y > c.Height - mWidth
                    c.Cursor = Cursors.SizeNESW
                    mEdge = EdgeEnum.BottomLeft
                Case e.X > c.Width - mWidth And e.Y <= mWidth
                    c.Cursor = Cursors.SizeNESW
                    mEdge = EdgeEnum.TopRight
                Case e.X <= mWidth And e.Y <= mWidth
                    c.Cursor = Cursors.SizeNWSE
                    mEdge = EdgeEnum.TopLeft
                Case e.X <= mWidth And e.Y >= c.Height \ 2 - 4 And e.Y <= c.Height \ 2 + 4
                    c.Cursor = Cursors.SizeWE
                    mEdge = EdgeEnum.Left
                Case e.X >= c.Width - mWidth And e.Y >= c.Height \ 2 - 4 And e.Y <= c.Height \ 2 + 4
                    c.Cursor = Cursors.SizeWE
                    mEdge = EdgeEnum.Right
                Case e.X >= c.Width \ 2 - 4 And e.X <= c.Width \ 2 + 4 And e.Y <= mWidth
                    c.Cursor = Cursors.SizeNS
                    mEdge = EdgeEnum.Top
                Case e.X >= c.Width \ 2 - 4 And e.X <= c.Width \ 2 + 4 And e.Y >= c.Height - mWidth
                    c.Cursor = Cursors.SizeNS
                    mEdge = EdgeEnum.Bottom
                Case e.X <= c.Width And e.Y <= c.Height
