...
Public Class UcCommandScheduler
    ...
    Private Const SchedulerFolderPath As String = "c:\casparcg\mydata\scheduler\"
        ...
        Using sw As New StreamWriter(fileName)
            ...
            Else
                For rowIndex = 0 To dgvscheduler.Rows.Count - 1
                    sw.WriteLine(Format(CType(dgvscheduler.Rows(rowIndex).Cells(0).Value, DateTime), "H:mm:ss") & RowSeparator & dgvscheduler.Rows(rowIndex).Cells(2).Value)
                Next
            End If
        End Using
