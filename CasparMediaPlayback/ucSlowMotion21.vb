...
Public Class ucSlowMotion21
    ...
    Private Sub frmSlowMotion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        UcSMRecorder2.cmbscreenConsumres.Text = "Screen consumer [3|1080i5000]"
        ...
        UcnewSM21.cmbscreenConsumres.Text = "Screen consumer [2|1080i5000]"

        UcnewSM22.cmbChannel.Text = 4
        UcnewSM22.Label2.Text = "Channel 4"
        UcnewSM22.cmbscreenConsumres.Text = "Screen consumer [4|1080i5000]"
    End Sub
